...
tbl8 = CSV.read(inputdir * table8name * ".csv", DataFrame)
tbl5 = CSV.read(inputdir * table5name * ".csv", DataFrame)
tblkap = CSV.read(inputdir * tablekapname * ".csv", DataFrame)
tbllab = CSV.read(inputdir * tablelabname * ".csv", DataFrame)
tbldiff = CSV.read(inputdir * tablediffname * ".csv", DataFrame)
tbloutperdiv = CSV.read(inputdir * tableoutname * ".csv", DataFrame)
#tblpop = CSV.read(inputdir * tablepopname * ".csv", DataFrame)
