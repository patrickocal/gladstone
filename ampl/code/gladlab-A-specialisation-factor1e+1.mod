...
let A_CON := 00600e-2; #increase this to increase labour and consumption
let A_INV := 0111e-2;
let A_MED := 0010e-2;
let A_VAL := 0001e-2;
...
table res OUT "amplxl" (outputdir & "burn-in-fin.xlsx") "Results":
  [Regions, Sectors, PathTimes],
  KAP, E_OUT, CON, XPO, YMED_CSUM, GROWTH_KAP, GROWTH_OUT,
  EULER_INTEGRAND, EULER_RATIO;
table aggres OUT "amplxl" (outputdir & "agg-results-fin.xlsx") "Results":
  [Regions, PathTimes],
